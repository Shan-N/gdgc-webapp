...
const DiscordPromoCard = () => {
  return (
    <div className="flex justify-center items-center p-4">
      <motion.div 
        className="relative bg-[#5865F2] text-white rounded-3xl shadow-xl overflow-hidden max-w-4xl w-full"
      ...
      >
        <div className="flex flex-col md:flex-row items-center p-8">
          <div className="flex-1 z-10">
            ...
            >
              Connect with our community, get support, and stay updated!
            </motion.p>
            <a href='/forms/3856a1e7-7135-4746-b545-fb3df9136792'>
              <motion.button 
                className="bg-white text-[#5865F2] font-bold py-2 px-6 rounded-full hover:bg-opacity-90 transition duration-300"
          ...
          >
            <picture>
              <img 
                src="https://res.cloudinary.com/dfyrk32ua/image/upload/v1728811507/discord_wa613x.png" 
...
export default DiscordPromoCard;